...
## Project Structure
    ...
    ├── tstdanifimox_dev_22917  # Django project configurations
...
1. Clone this repo and `cd tstdanifimox_dev_22917`
...
2. Clone this repo and `cd tstdanifimox_dev_22917`
